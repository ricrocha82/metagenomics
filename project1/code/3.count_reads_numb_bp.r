...
df_numbers <- list.files("/fs/project/PAS1117/ricardo/metaG/project1/2.clean_reads", full.names = T) %>% map_df(count_fa)

vroom_write(df_numbers , here("metaG_read_and_bp_numbers.txt"))
